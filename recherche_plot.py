...
intervalledebut=float(input('Veuillez indiquer un début d intervalle pour les longueurs d onde pour lesquelles vous souhaitez avoir les intensités correspondantes\n')) #fonction input pour que l'utilisateur définisse les brones de l'intervalle
